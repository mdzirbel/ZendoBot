<h2>Text-Based Implementation of Zendo, for Discord Servers</h2>
...
The person making the rule would enter "word is subset of dictionary" to create the rule.
Then people would guess things like "hello", "asdfghjkl", or "a b c d", and the bot responds with whether they fit the rule, in this case only the first guess fit